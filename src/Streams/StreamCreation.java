...
public class StreamCreation {
    ...
    public static Stream<Fish> caughtWithHand(Fish one, Fish two, Fish three) {
       // Stream<Fish> caught = Stream.of(one, two, three);
